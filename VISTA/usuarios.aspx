<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="usuarios.aspx.cs" Inherits="VISTA.usuarios" %>
                                    ...
                                    <asp:ListView ID="lstUsuarios" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><asp:Literal ID="litTipo" Text='<%#Eval("TipoUsuario.nombre") %>' runat="server"></asp:Literal></td>
                                                <td>
